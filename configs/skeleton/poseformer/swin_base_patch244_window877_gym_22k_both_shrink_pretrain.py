...
load_from = "/home/haoran/Video-Swin-Transformer/data/unityTrain/pretrained/swin_base_patch4_window7_224_22k.pth"

# runtime settings
checkpoint_config = dict(interval=1)
work_dir = './work_dirs/poseformer/swin_base_patch244_window877_gym_22k_both_shrink_pretrain'
find_unused_parameters = False

# optimizer_config = dict(grad_clip=None)P
