...
model=dict(backbone=dict(patch_size=(2,4,4), in_chans=34, drop_path_rate=0.3), cls_head=dict(num_classes=99), test_cfg=dict(max_testing_views=4))
...
work_dir = './work_dirs/GT_Poseformer/three_swin_base_patch244_window877_gymgt_22k_both_34_channel'
