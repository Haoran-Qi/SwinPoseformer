...
video_path ="/home/haoran/Video-Swin-Transformer/data/gym/subactions"
...
train_pipeline = [
    ...
    dict(type='FormatHeatMap', input_format='NCTHW'),
    dict(type='Collect', keys=['imgs', 'heatmaps', 'label'], meta_keys=[]),
    dict(type='ToTensor', keys=['imgs', 'heatmaps', 'label'])
]
val_pipeline = [
