...
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.3), cls_head=dict(num_classes=51), test_cfg=dict(max_testing_views=4))
...
work_dir = './work_dirs/swin_base_patch244_window877_hmdb51_22k_first.py'
